...
/* Transiciones entre Modals */
$("#btnIngHard").click(
  function(){
	$('#ingresoStock').show(900);
	$('.h_registrar_ingreso').show(900);
	$('#asignacionStock').hide(900);
	$('.h_registrar_asignacion').hide(900);
...
$("#btnAsigHard").click(
  function(){
	...
	$('.h_registrar_ingreso').hide(900);
	$('#asignacionStock').show(900);
	$('.h_registrar_asignacion').show(900);
	$('.stock a').removeClass('active');
	$(this).addClass('active');
  }
);
...
$("#btnEntHard").click(
  function(){
	...
	$('.h_registrar_entrada').show(900);
	$('#salidaHardware').hide(900);
	$('.h_registrar_salida').hide(900);
...
$("#btnSalHard").click(
  function(){
	...
	$('.h_registrar_entrada').hide(900);
	$('#salidaHardware').show(900);
	$('.h_registrar_salida').show(900);
	$('.soporteHardware a').removeClass('active');
	$(this).addClass('active');
  }
);
...
$("#btnAsigCel").click(
  function(){
	...
	$('.t_registrar_asignacion').show(900);
	$('#ingresoTelefonos').hide(900);
	$('.t_registrar_ingreso').hide(900);
...
$("#btnIngCel").click(
  function(){
    ...
    $('.t_registrar_asignacion').hide(900);
	$('#ingresoTelefonos').show(900);
	$('.t_registrar_ingreso').show(900);
	$('.stockTelefonos a').removeClass('active');
	$(this).addClass('active');
  }
);
...
$("#btnSalCel").click(
  function(){
	...
	$('.t_registrar_salida').show(900);
	$('#entradaTelefonos').hide(900);
	$('.t_registrar_entrada').hide(900);
...
$("#btnEntCel").click(
  function(){
	...
	$('.t_registrar_salida').hide(900);
	$('#entradaTelefonos').show(900);
	$('.t_registrar_entrada').show(900);
	$('.soporteTelefonos a').removeClass('active');
	$(this).addClass('active');
  }
);
